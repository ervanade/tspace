...
export async function generateMetadata({searchParams, params}) {
  ...
  return {
    title: isEnglish
      ? serviceData?.meta_title_en
      : serviceData?.meta_title_id,
    description: isEnglish
      ? serviceData?.meta_description_en
      : serviceData?.meta_description_id,
  };
...
const fetchServices = async (slug) => {
  ...
  const res = await fetch(`${process.env.NEXT_PUBLIC_API_KEY}/api/services/slug/${slug}`, {
