                    ...
                    >
                      ...
                      <div className="p-6 pt-0">
                        <Link
                          ...
                          type="button"
                          aria-label={`Baca lebih lanjut tentang ${lang === "en" ? article.title_en : article.title_id}`}
                title={`Baca lebih lanjut tentang ${lang === "en" ? article.title_en : article.title_id}`}
                        >
                          Read More
                        </Link>
                      </div>
